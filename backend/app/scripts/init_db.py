...
async def main() -> None:
    ...
    await db.attendees.create_index("id", unique=True)
    ...
    await db.attendees.create_index([("event_id", 1), ("deleted_at", 1)])
    await db.attendees.create_index([("event_id", 1), ("full_name", 1)])
